<?php
    ...
    $user_duels_targeted_exist=$theUser->loadUserDuelsTargeted($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="8">Les duels où <?php echo $theUser->getUser_id(); ?> est la cible</th>
            </tr>
            <tr>
                <th>Provocateur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_duels_targeted_exist)
    {
        foreach ($theUser->getUserDuelsTargeted() as $duel)
        {?>
            <tr>
                <td>
...
<?php
    ...
    {?>
            <tr>
                <td colspan="8">
                    <span class="nothing">Pas de duels ciblés</span>
                </td>
            </tr>
<?php   
    }
