...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            require('Availability_Detail_Content_Header.php'); 
            require('Availability_Detail_Content_Menu.php');
            switch ($page_number)
            {
                case 0:
                    require('Availability_Detail_Content_Sessions.php');
                    break;
                default :
                    require('Availability_Detail_Content_Sessions.php');
            }
        ...
        <?php require('Availability_Detail_Pop_Ups.php'); ?>
