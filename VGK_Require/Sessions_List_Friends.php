<?php
    ...
    $user_friends_sessions_hosted_exist=$theUser->loadUserFriendsSessionsHosted($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="10">Les sessions hébergées par les amis de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Hôte</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_friends_sessions_hosted_exist)
    {
        foreach ($theUser->getUserFriendsSessionsHosted() as $session)
        {?>
            <tr>
                <td>
