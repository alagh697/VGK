<?php
    ...
    $user_follows_sessions_hosted_exist=$theUser->loadUserFollowsSessionsHosted($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="10">Les sessions hébergées par les abonnements de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Hôte</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_follows_sessions_hosted_exist)
    {
        foreach ($theUser->getUserFollowsSessionsHosted() as $session)
        {?>
            <tr>
                <td>
