<?php
    ...
    $user_follows_challenges_made_exist=$theUser->loadUserFollowsChallengesMade($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="6">Les défis des abonnements de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Lanceur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_follows_challenges_made_exist)
    {
        foreach ($theUser->getUserFollowsChallengesMade() as $challenge)
        {?>
            <tr>
                <td>
