<?php
    $friends_exist=$session_user->loadUserFriends($database);
?>
...
<?php 
    if($friends_exist)
    {
        ...
        {?>
            <tr>
                <td>
                    <a href=""><img src="VGK_Image/Profile_Picture/<?php echo $friendship->getFriendship_friend1()->getUser_profile_picture_url(); ?>" height="30" width="30" align="center"></a>
