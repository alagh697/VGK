<?php
    ...
    $user_library_goals_exist=$theUser->loadUserLibraryGoals($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="7">Les objectifs sur les jeux de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Joueur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_library_goals_exist)
    {
        foreach ($theUser->getUserLibraryGoals() as $goal)
        {?>
            <tr>
                <td>
