<?php
    $game_availabilities_exist=$theGame->loadGameAvailabilities($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="7">Les disponibilités sur  <?php echo $theGame->getGame_name(); ?></th>
            </tr>
            <tr>
                <th>Joueur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($game_availabilities_exist)
    {
        foreach ($theGame->getGameAvailabilities() as $availability)
        {?>
            <tr>
                <td>
