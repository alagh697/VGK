<?php
    ...
    $user_duels_originated_exist=$theUser->loadUserDuelsOriginated($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="8">Les duels provoqués par <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Cible</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_duels_originated_exist)
    {
        foreach ($theUser->getUserDuelsOriginated() as $duel)
        {?>
            <tr>
                <td>
