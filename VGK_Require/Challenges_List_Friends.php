<?php
    ...
    $user_friends_challenges_made_exist=$theUser->loadUserFriendsChallengesMade($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="6">Les défis des amis de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Lanceur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_friends_challenges_made_exist)
    {
        foreach ($theUser->getUserFriendsChallengesMade() as $challenge)
        {?>
            <tr>
                <td>
