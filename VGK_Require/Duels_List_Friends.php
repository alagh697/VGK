<?php
    ...
    $user_friends_duels_originated_exist=$theUser->loadUserFriendsDuelsOriginated($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="9">Les duels provoqués par les amis de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Provocateur</th>
                <th>Cible</th>
        ...
        <tbody>
<?php 
    if($user_friends_duels_originated_exist)
    {
        foreach ($theUser->getUserFriendsDuelsOriginated() as $duel)
        {?>
            <tr>
                <td>
