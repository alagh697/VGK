<?php
    $game_sessions_exist=$theGame->loadGameSessions($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="10">Les sessions hébergées sur <?php echo $theGame->getGame_name(); ?></th>
            </tr>
            <tr>
                <th>Hôte</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($game_sessions_exist)
    {
        foreach ($theGame->getGameSessions() as $session)
        {?>
            <tr>
                <td>
