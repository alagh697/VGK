<?php
    ...
    $user_friends_availabilities_exist=$theUser->loadUserFriendsAvailabilities($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="7">Les disponibilités des amis de  <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Joueur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_friends_availabilities_exist)
    {
        foreach ($theUser->getUserFriendsAvailabilities() as $availability)
        {?>
            <tr>
                <td>
