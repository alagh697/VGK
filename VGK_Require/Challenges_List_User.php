<?php
    ...
    $user_challenges_made_exist=$theUser->loadUserChallengesMade($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="5">Les défis de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Jeu</th>
                <th>Titre</th>
        ...
        <tbody>
<?php 
    if($user_challenges_made_exist)
    {
        foreach ($theUser->getUserChallengesMade() as $challenge)
        {?>
            <tr>
                <td>
