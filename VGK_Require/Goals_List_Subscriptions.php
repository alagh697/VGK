<?php
    ...
    $user_follows_goals_exist=$theUser->loadUserFollowsGoals($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="7">Les objectifs des abonnements de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Joueur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_follows_goals_exist)
    {
        foreach ($theUser->getUserFollowsGoals() as $goal)
        {?>
            <tr>
                <td>
