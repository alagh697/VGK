<?php
    ...
    $user_friends_goals_exist=$theUser->loadUserFriendsGoals($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="7">Les objectifs des amis de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Joueur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_friends_goals_exist)
    {
        foreach ($theUser->getUserFriendsGoals() as $goal)
        {?>
            <tr>
                <td>
