<?php
    ...
    $user_follows_duels_originated_exist=$theUser->loadUserFollowsDuelsOriginated($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="9">Les duels provoqués par les abonnements de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Provocateur</th>
                <th>Cible</th>
        ...
        <tbody>
<?php 
    if($user_follows_duels_originated_exist)
    {
        foreach ($theUser->getUserFollowsDuelsOriginated() as $duel)
        {?>
            <tr>
                <td>
