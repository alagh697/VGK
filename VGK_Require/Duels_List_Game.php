<?php
    $game_duels_exist=$theGame->loadGameDuels($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="9">Les duels provoqués sur <?php echo $theGame->getGame_name(); ?></th>
            </tr>
            <tr>
                <th>Provocateur</th>
                <th>Cible</th>
...
<?php 
    if($game_duels_exist)
    {
        foreach ($theGame->getGameDuels() as $duel)
        {?>
            <tr>
                <td>
