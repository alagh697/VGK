<?php
    ...
    $user_follows_availabilities_exist=$theUser->loadUserFollowsAvailabilities($database);
?>
<div class="content_content">	
    <table class="activity_table">
        <thead>
            <tr>
                <th colspan="7">Les disponibilités des abonnements de <?php echo $theUser->getUser_id(); ?></th>
            </tr>
            <tr>
                <th>Joueur</th>
                <th>Jeu</th>
        ...
        <tbody>
<?php 
    if($user_follows_availabilities_exist)
    {
        foreach ($theUser->getUserFollowsAvailabilities() as $availability)
        {?>
            <tr>
                <td>
