...
<html>
    ...
    <body>
        ...
        <div class="content">
            <?php
            //Navigation in the goals section
            ...
            require('Goals_Content_Header.php'); 
            require('Goals_Content_Menu.php'); 
            ...
            switch ($page_number)
            {
                case 0:
                    ...
                    break;
                case 1:
                    require('Goals_List_Friends.php');
                    break;
                case 2:
                    require('Goals_List_Subscriptions.php');
                    break;
                case 3:
                    require('Goals_List_All.php');
                    break;
                default :
                    require('Goals_List_User.php');
            }
